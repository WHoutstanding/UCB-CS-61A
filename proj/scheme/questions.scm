...
(define (enumerate s)
  ; BEGIN PROBLEM 15
    (define (enumerate-helper n s)
        (if (null? s)
            '()
            (cons (cons n (cons (car s) nil)) (enumerate-helper (+ n 1) (cdr s)))
        )
    )
